...
insert into players (team_name,position,jersey_number) values ('He plays for Liverpool FC','He plays as a forward', 'He Wears jersey number 11');
insert into players (team_name,position,jersey_number) values ('He plays for Manchester City FC','He plays as a striker', 'He Wears jersey number 9');
insert into players (team_name,position,jersey_number) values ('He plays for Liverpool FC','He plays as a forward', 'He Wears jersey number 11');
insert into players (team_name,position,jersey_number) values ('He plays for Evaton FC','He plays as a defensive midfielder', 'He Wears jersey number 8');
insert into players (team_name,position,jersey_number) values ('He plays for  Wolverhampton Wanderers FC','He plays as a Defender', 'He Wears jersey number 19');
